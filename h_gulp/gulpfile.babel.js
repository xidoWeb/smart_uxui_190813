...
// ================================
/* 삭제하기 */
async function FnAlldel(){
	return del('./public/', {force:true});
};

async function Fndel(){
	return del(['./public/dest/**', '!public'], {force:true});
}

// ================================
/*외부에서 사용하기(내보내기)*/
export const makedir = FnmakeDir;
export const makefile = gulp.series(FnmakeDir, gulp.parallel(Fnmakefile, Fnjquery) );
